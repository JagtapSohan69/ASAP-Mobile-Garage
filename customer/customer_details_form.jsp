...
<form id="WFS_Riz" name="form1" method="post" action="customer_details_insert.jsp">
  ...
  <label>DOB</label>
  <div>
        <input class="validate[required,custom[date]]  form-control" style="width:90%" name="dob" type="text" id="dob">
      </div>
 </div>
 </br>
     <div>
