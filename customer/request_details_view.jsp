...
ResultSet rs=s.stm.executeQuery("select * from request_details r,customer_details c,garage_details g where c.c_id=r.c_id and g.g_id=r.g_id and c.c_email='"+rz+"'");
while(rs.next())
{
...
%>  
  <tr>
	...
	<td><div align="center"><%=rs.getString("location")%></div></td>
   ...
   <td><div align="center"><font color="#0099FF" size="4">Requested</font></div></td>
     <td><div align="center"><a href="request_details_delete.jsp?id=<%=sid%>" class="btn btn-danger" title="Delete">X</a> </div></td>
