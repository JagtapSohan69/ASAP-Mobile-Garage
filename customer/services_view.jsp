   ...
   <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Services | <a class="btn btn-primary" href="garage_details_view.jsp"><i class="fa fa-arrow-left"></i> Back</a>
                        </div>
...
ResultSet rs=s.stm.executeQuery("select * from services s,garage_details g where g.g_id=s.g_id and g.g_id='"+gid+"'");
while(rs.next())
{
...
%>    
    ...
    <td><div align="center"><i class="fa fa-inr"></i> <%=rs.getString("s_price")%> /-</div></td>
