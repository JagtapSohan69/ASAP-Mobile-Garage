...
<jsp:include page="sidebar.jsp"></jsp:include>
 <div id="page-wrapper" >
  ...
  <tr>
    ...
    <th width="100"><div align="center">Vendor</div></th>
    <th width="100"><div align="center">Garage Name </div></th>
    <th width="120"><div align="center"> Description </div></th>
    <th width="100"><div align="center"> City </div></th>
    <th width="100"><div align="center">Address</div></th>
...
ResultSet rs=s.stm.executeQuery("select * from garage_details g,vendor_details v where v.v_id=g.v_id and v.v_id='"+id+"'");
while(rs.next())
{
...
%>  
  ...
  <!--  <td><div align="center"><%=rs.getString("g_latitude")%></div></td>
    <td><div align="center"><%=rs.getString("g_longitude")%></div></td> -->
     <% if(st.equals("Open")) { %>
   <td><div align="center"><font color="#009900" size="5">Open</font></div></td>
   <% } else { %>
   <td><div align="center"><font color="#FF0000" size="5">Closed</font></div></td>
   <% } %>
