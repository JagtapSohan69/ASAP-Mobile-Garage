...
ResultSet rs1=s.stm.executeQuery("select count(v.v_id) as tv from vendor_details v,login l where v.v_email=l.username and l.status='active'");
rs1.next();
int tv=rs1.getInt("tv");

ResultSet rs2=s.stm.executeQuery("select count(c_id) as tc from customer_details");
rs2.next();
int tc=rs2.getInt("tc");

ResultSet rs3=s.stm.executeQuery("select count(fd_id) as tf from feedback_details");
rs3.next();
int tf=rs3.getInt("tf");

ResultSet rs4=s.stm.executeQuery("select count(n_id) as tn from notices");
rs4.next();
...
%>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                   <p class="main-text">
                    ...
                    <p class="main-text" style="font-size:18px">Vendors</p>
                </div>
             </div>
		     </div>
			...
			<div class="panel panel-back noti-box">
			 ...
			 <div align="center"><img src="../wfs_temp/img/admin.jpg" width="90%"/></div>
			</div>
                 <!-- /. ROW  -->
