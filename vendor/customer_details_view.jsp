...
<jsp:include page="sidebar.jsp"></jsp:include>
 <div id="page-wrapper" >
   ...
   <!--   Kitchen Sink -->
	...
	<thead>
  <tr>
    <th width="49" height="52"><div align="center">C Id </div></th>
    <th width="55"><div align="center">Fname</div></th>
    <th width="43"><div align="center">Lname</div></th>
...
%>  
  <tr>
    <td><div align="center"><%=rs.getString("c_id")%></div></td>
    ...
    <td><div align="center"><%=rs.getString("c_profilepic")%></div></td>
