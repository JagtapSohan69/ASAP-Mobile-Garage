...
<div>
  <label>Service Description </label>
      <div>
          <textarea name="sd" class="validate[required]  form-control" id="sd" style="width:90%"></textarea>
  </div>
</dir>
</br>		
<div>
  <label>Price</label>
      <div>    
          <input class="validate[required,custom[onlyNumber]] form-control" maxlength="4" style="width:90%"name="sp" type="text" id="sp">
        </div>
</div>
</br>		
    <div align="center">
