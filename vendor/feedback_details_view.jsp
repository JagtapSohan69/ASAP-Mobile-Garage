...
ResultSet rs=s.stm.executeQuery("select * from feedback_details fd,customer_details c,vendor_details v where c.c_email=fd_from and v.v_email=fd.fd_to and v.v_email='"+rz+"'");
while(rs.next())
{
