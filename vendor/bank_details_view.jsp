...
<jsp:getProperty name="s" property="conn"/>
  ...
  <tr>
   ...
   <!-- <th width="101"><div align="center">Card Number </div></th>
    ...
    <th width="100"><div align="center">Amount</div></th>
...
<%
int sl=0;
ResultSet rs=s.stm.executeQuery("select * from bank_details b,vendor_details v where b.b_accountholder=v.v_email and v.v_email='"+rz+"'");
while(rs.next())
{
