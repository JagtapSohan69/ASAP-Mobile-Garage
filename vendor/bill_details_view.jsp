...
ResultSet rs=s.stm.executeQuery("select * from bill_details b,customer_details c,garage_details g,vendor_details v where g.g_id=b.g_id and b.c_id=c.c_id and g.v_id=v.v_id and v.v_email='"+rz+"'");
while(rs.next())
{
...
%>  
  <tr>
	...
	<td><div align="center"><i class="fa fa-inr"></i> <%=rs.getString("b_amount")%> /-</div></td>
